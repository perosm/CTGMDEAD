...
from dataset.nuscenes.nuscenes_devkit.nuscenes.utils.detection_utils import (
...
from dataset.nuscenes.nuscenes_devkit.nuscenes.utils.kitti import KittiDB
from dataset.nuscenes.nuscenes_devkit.nuscenes.utils.splits import create_splits_logs
...
class KittiConverter:
    def __init__(
        ...
        """
        self.nusc_kitti_dir = (
            "./data/nuscenes_kitti"  # os.path.expanduser(nusc_kitti_dir)
        )
        ...
        self.nusc = NuScenes(dataroot="./data/nuscenes/nuscenes", version=nusc_version)
